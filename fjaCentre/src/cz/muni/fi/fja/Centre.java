...
public class Centre {
   ...
   */
  public boolean convertDevice(String p_source, String p_device, String p_destination) {
    prepareAttributes(true);
    createEvaluator(p_source);
    return m_evaluator.convertDevice(p_source, p_device, p_destination);
  }
...
//    }
  ...
  public String toString() {
    ...
    l_sb.append("<table class=main><tr><td class=answer>");
    if (!m_converting) {
      l_sb.append("Zadana uloha: ").
    ...
    l_sb.append("</td></tr><tr><td class=answer>");
    if (getError() != null) {
      l_sb.append("FALSE: ").append(getError().toString());
    } else {
      l_sb.append("TRUE: bez chyb");
    }
    l_sb.append("</td></tr>").append("<tr><td><hr></td></tr>");
    if (!m_converting) {
    ...
    if (m_converting) {
      l_sb.append("<table class=teacher><caption>Prevadeny model</caption>").
